...
public class CustomLinkedList<T> {
    ...
    private static class CustomIteratorImpl<T> implements CustomIterator<T> {
        private ListNode<T> currentNode;

        public CustomIteratorImpl(CustomLinkedList<T> list) {
    ...
    public CustomIterator<T> iterator() {
        return new CustomIteratorImpl<>(this);
    }
    ...
    public final void addAll(T... elements) {
        if (elements == null) {
            throw new IllegalArgumentException("Элементы являются null");
        }
